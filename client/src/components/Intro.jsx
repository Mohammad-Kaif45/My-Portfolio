...
const Intro = () => {
  return (
    <section id="intro" className="py-24 bg-gray-950 text-gray-100">
      <div className="container mx-auto px-6 max-w-5xl flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="md:w-3/5 text-center md:text-left flex flex-col justify-center">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-tighter leading-tight">
            Hi, I'm <span className="text-lime-400">Kaif Ansari</span>, a B.Tech CSE (2026) student.
          </h1>
          ...
          <a 
            href="#contact" 
            className="inline-block self-center md:self-start bg-lime-500 hover:bg-lime-600 text-gray-950 font-bold py-4 px-8 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-200 text-lg group"
          >
        ...
        <div className="md:w-2/5 flex justify-center items-center">
          <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-8 border-gray-900 shadow-2xl relative">
            <img 
            ...
            <div className="absolute inset-0 rounded-full border-4 border-lime-400 opacity-30 animate-pulse"></div>
          </div>
        </div>
      </div>
    </section>
